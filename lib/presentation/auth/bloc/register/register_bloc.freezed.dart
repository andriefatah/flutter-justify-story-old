...
class _$SuccessImpl with DiagnosticableTreeMixin implements _Success {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'RegisterState.success'));
  }
...
class _$ErrorImpl with DiagnosticableTreeMixin implements _Error {
  const _$ErrorImpl(final Map<String, dynamic> errors) : _errors = errors;
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'RegisterState.error(errors: $errors)';
  }
...
abstract class _Error implements RegisterState {
  const factory _Error(final Map<String, dynamic> errors) = _$ErrorImpl;
